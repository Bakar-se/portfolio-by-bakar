  ...
  return (
    ...
    >
      <Avatar
        ...
        role="img"
        aria-label="Bakar's profile picture"
      >
        <AvatarImage
          src="/pic.jpg"
          alt="Muhammad Abu Bakar's profile picture"
          width={128}
          height={128}
      ...
      <WordReveal text="Muhammad Abu Bakar" delay={0.15} />
      ...
      words={["Software Engineer", "Full Stack Developer", "AI Engineer"]}
    />
        </div>
      </MotionEffect>
      <MotionEffect
