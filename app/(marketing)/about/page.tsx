                    ...
                    >
                      ...
                      <li className="flex gap-x-3">
                        ...
                        <span>
                          ...
                          from the University of Gujrat in Pakistan.
                        </span>
                      </li>
                      <li className="flex gap-x-3">
                        <CheckIcon
                        ...
                        <span>
                          ...
                          <strong className="font-semibold">Full Stack Applications</strong>,{" "}
                          <strong className="font-semibold">
                            AI
                          </strong>
                      ...
                      <li className="flex gap-x-3">
                        ...
                        <span>
                          ...
                          {", "}
                          <strong className="font-semibold">Urdu</strong>
                          {", "} and{" "}
                          <strong className="font-semibold">Punjabi</strong>
                          .
                        </span>
                      </li>
                      <li className="flex gap-x-3">
                        ...
                        />
                        <span>
                          He learns ⚡fast, and is flexible with technologies.
                        </span>
                      </li>
                      <li className="flex gap-x-3">
                        <CheckIcon
                        ...
                        />
                        <span>
                          When he is not 🧑‍💻coding, he is watching movies.
                        </span>
                      </li>
                    </ul>
                  </article>
